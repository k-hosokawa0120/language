...
<div class="border col-7">
    ...
    <table>
      ...
      <form action="/PlayerController.php" method="post">
        <br>
          <p><a href="my_photo.php">画像を設定する</a></p>
        <br>
      </form> -->
          ...
          <div class="col-md">
              <form action="my_page_confirm.php" method="post">
                  <div class="form-group">
                      <label>表示する名前：</label>
                      <input type="text" class="form-control" name="nickname" value="<?=$params['player']['nickname'] ?>" required>
                  </div>
                  <div class="form-group">
                      <label>性別：</label>
                      <input type="text" class="form-control" name="sex" value="<?=$params['player']['sex']?>" readonly>
                  </div>
                  <div class="form-group">
                      <label>年齢：</label>
                      <select class="form-control" name="age" required>
                          <option selected value="<?=$params['player']['age']?>"><?=$params['player']['age']?></option>
                  ...
                  <div class="form-group">
                      ...
                      <option selected value="<?=$params['player']['residence']?>"><?=$params['player']['residence']?></option>
                  ...
                  <div class="form-group" name="country" required>
                      <label>出身国：</label>
                      <input type="text" class="form-control" name="country" value="<?=$params['player']['country']?>" readonly>
                  </div>
                  <div class="form-group" name="teach_language" required>
                      <label>教えられる言語：</label>
                      <select class="form-control" name="teach_language">
                          <option selected value="<?=$params['player']['teach_language']?>"><?=$params['player']['teach_language']?></option>
                          <option>日本語</option>
                          <option>英語</option>
                          <option>中国語</option>
                          <option>韓国語</option>
                  ...
                  <div class="form-group" name="study_language" required>
                      ...
                      <select class="form-control" name="study_language">
                          <option selected value="<?=$params['player']['study_language']?>"><?=$params['player']['study_language']?></option>
                          <option>日本語</option>
                          <option>英語</option>
                          <option>中国語</option>
                          <option>韓国語</option>
                  ...
                  <div class="form-group" name="status_1" required>
                      ...
                      <select class="form-control" name="status_1">
                          <option selected value="<?=$params['player']['status_1']?>"><?=$params['player']['status_1']?></option>
                          <option>スポーツ</option>
                          <option>cafe</option>
                          <option>食事</option>
                          <option>買い物</option>
                  ...
                  <div class="form-group" name="status_2" required>
                      ...
                      <select class="form-control" name="status_2">
                          <option selected value="<?=$params['player']['status_2']?>"><?=$params['player']['status_2']?></option>
                          <option value="">-</option>
                          <option>スポーツ</option>
                          <option>cafe</option>
                          <option>食事</option>
                  ...
                  <div class="row center-block text-center">
                    <div class="col-5">
                        <input type="submit" class="btn btn-outline-primary btn-block" value="変更内容を確認する">
                    </div>
                  </div>
              </form>
          </div>
  ...
  <form action="/PlayerController.php" method="post">
    <br>
      <p><a href="delete.php">退会する場合はこちら</a></p>
    <br>
  </form>
